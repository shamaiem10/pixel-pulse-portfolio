...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section relative min-h-screen flex items-center justify-center pixel-grid overflow-hidden">
      <div className="scanlines absolute inset-0 pointer-events-none" aria-hidden="true" />
      <div className="hero-scan absolute left-0 right-0 h-px pointer-events-none" aria-hidden="true" />
      ...
      {/* Gradient orbs */}
      <div className="ambient-orb absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
      <div className="ambient-orb ambient-orb--yellow absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
        ...
        <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto mb-10 leading-relaxed animate-fade-up" style={{ animationDelay: "0.3s" }}>
          I build <span className="text-foreground font-medium">AI-powered products and automation workflows</span>{" "}
          that turn complex problems into useful, human-centered experiences.
        </p>
